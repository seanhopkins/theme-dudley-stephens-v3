...
SPENDX_GETY_FORZ = [
  {
    ...
    product_selector_match_type: :include,
    product_selector_type: :product_id,
    product_selectors: [3952059940906],
    threshold: 150,
    quantity_to_discount: 1,
    discount_type: :percent,
    discount_amount: 100,
    discount_message: 'Spend $150 get a Hemlock Headband',
  },
  {
    product_property_key: '_is_gwp',
    product_selector_match_type: :include,
    product_selector_type: :product_id,
    product_selectors: [3952059940906,6923672420394],
    threshold: 200,
    quantity_to_discount: 1,
    discount_type: :percent,
    discount_amount: 100,
    discount_message: 'Enter a message here',
  },
]
