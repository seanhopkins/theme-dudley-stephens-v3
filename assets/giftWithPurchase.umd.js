...
var arraySlice = __webpack_require__(206);
var validateArgumentsLength = __webpack_require__(8398);
...
var shared_esm_bundler_isReservedProp = /* @__PURE__ */shared_esm_bundler_makeMap(
...
var shared_esm_bundler_toNumber = function toNumber(val) {
  var n = shared_esm_bundler_isString(val) ? Number(val) : NaN;
  return isNaN(n) ? val : n;
};
var _globalThis;
...
var isBooleanAttr = /* @__PURE__ */shared_esm_bundler_makeMap(specialBooleanAttrs + ",async,autofocus,autoplay,controls,default,defer,disabled,hidden,inert,loop,open,required,reversed,scoped,seamless,checked,muted,multiple,selected");
...
function reactivity_esm_bundler_hasOwnProperty(key) {
  var obj = reactivity_esm_bundler_toRaw(this);
...
var RefImpl = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  ...
  _createClass(RefImpl, [{
    ...
    set: function set(newVal) {
      var useDirectValue = this.__v_isShallow || isShallow(newVal) || reactivity_esm_bundler_isReadonly(newVal);
...
var GetterRefImpl = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
...
function assertNumber(val, type) {
  ...
  if (val === void 0) {
    ...
    runtime_core_esm_bundler_warn("".concat(type, " is not a valid number - got ").concat(JSON.stringify(val), "."));
  } else if (isNaN(val)) {
    runtime_core_esm_bundler_warn("".concat(type, " is NaN - the duration expression might be incorrect."));
  }
}
...
function queuePostFlushCb(cb) {
  if (!shared_esm_bundler_isArray(cb)) {
    ...
    pendingPostFlushCbs.push.apply(pendingPostFlushCbs, toConsumableArray_toConsumableArray(cb));
  }
  queueFlush();
}
function flushPreFlushCbs(seen) {
  ...
  for (; i < runtime_core_esm_bundler_queue.length; i++) {
    var cb = runtime_core_esm_bundler_queue[i];
    if (cb && cb.pre) {
      if (false) {}
      runtime_core_esm_bundler_queue.splice(i, 1);
      i--;
...
function emit(instance, event) {
  ...
  if (modelArg && modelArg in props) {
    ...
    if (trim) {
      args = rawArgs.map(function (a) {
        return shared_esm_bundler_isString(a) ? a.trim() : a;
      });
    }
    if (number) {
  ...
  var handlerName;
  var handler = props[handlerName = shared_esm_bundler_toHandlerKey(event)] ||
...
function createSuspenseBoundary(vnode, parentSuspense, parentComponent, container, hiddenContainer, anchor, isSVG, slotScopeIds, optimized, rendererInternals) {
  ...
  var timeout = vnode.props ? shared_esm_bundler_toNumber(vnode.props.timeout) : void 0;
  if (false) {}
  var suspense = {
    vnode: vnode,
...
function createInnerComp(comp, parent) {
  var _parent$vnode = parent.vnode,
    ...
    ce = _parent$vnode.ce;
  var vnode = runtime_core_esm_bundler_createVNode(comp, props, children);
  vnode.ref = ref2;
  vnode.ce = ce;
...
var KeepAliveImpl = {
  ...
  setup: function setup(props, _ref9) {
    ...
    watch(function () {
      ...
      var _ref11 = slicedToArray_slicedToArray(_ref10, 2),
        include = _ref11[0],
        exclude = _ref11[1];
...
var hasSetupBinding = function hasSetupBinding(state, key) {
  return state !== shared_esm_bundler_EMPTY_OBJ && !state.__isScriptSetup && shared_esm_bundler_hasOwn(state, key);
};
...
function normalizePropsOrEmits(props) {
  return shared_esm_bundler_isArray(props) ? props.reduce(function (normalized, p) {
...
function mergeEmitsOrPropsOptions(to, from) {
  if (to) {
    if (shared_esm_bundler_isArray(to) && shared_esm_bundler_isArray(from)) {
      return toConsumableArray_toConsumableArray( /* @__PURE__ */new Set([].concat(toConsumableArray_toConsumableArray(to), toConsumableArray_toConsumableArray(from))));
    }
...
function mergeWatchOptions(to, from) {
  if (!to) return from;
  if (!from) return to;
  var merged = shared_esm_bundler_extend( /* @__PURE__ */Object.create(null), to);
  for (var key in from) {
  ...
  return function createApp(rootComponent) {
    ...
    var app = context.app = {
      ...
      mount: function mount(rootContainer, isHydrate, isSVG) {
        if (!isMounted) {
          if (false) {}
          var vnode = runtime_core_esm_bundler_createVNode(rootComponent, rootProps);
  ...
  // - vite#872 non-sfc component used by sfc component
   true && (optimized || patchFlag > 0) && !(patchFlag & 16)) {
      ...
      for (var i = 0; i < propsToUpdate.length; i++) {
        ...
        if (options) {
          if (shared_esm_bundler_hasOwn(attrs, key)) {
            ...
            var camelizedKey = shared_esm_bundler_camelize(key);
    ...
    for (var _key10 in rawCurrentProps) {
      if (!rawProps ||
      // for camelCase
      !shared_esm_bundler_hasOwn(rawProps, _key10) && (
      // it's possible the original props was passed in as kebab-case
      // and converted to camelCase (#955)
      (kebabKey = shared_esm_bundler_hyphenate(_key10)) === _key10 || !shared_esm_bundler_hasOwn(rawProps, kebabKey))) {
        if (options) {
          if (rawPrevProps && (
          // for camelCase
    ...
    if (attrs !== rawCurrentProps) {
      for (var _key11 in attrs) {
        if (!rawProps || !shared_esm_bundler_hasOwn(rawProps, _key11) && true) {
          delete attrs[_key11];
          hasAttrsChanged = true;
        }
      }
...
function setFullProps(instance, rawProps, props, attrs) {
  ...
  if (needCastKeys) {
    ...
    for (var i = 0; i < needCastKeys.length; i++) {
      ...
      props[_key12] = resolvePropValue(options, rawCurrentProps, _key12, castValues[_key12], instance, !shared_esm_bundler_hasOwn(castValues, _key12));
    }
  }
...
function resolvePropValue(options, props, key, value, instance, isAbsent) {
  var opt = options[key];
  if (opt != null) {
    var hasDefault = shared_esm_bundler_hasOwn(opt, "default");
...
function setRef(rawRef, oldRawRef, parentSuspense, vnode) {
  ...
  if (shared_esm_bundler_isFunction(ref)) {
    ...
    var _isString = shared_esm_bundler_isString(ref);
    var _isRef = reactivity_esm_bundler_isRef(ref);
    if (_isString || _isRef) {
      var doSet = function doSet() {
        if (rawRef.f) {
          var existing = _isString ? shared_esm_bundler_hasOwn(setupState, ref) ? setupState[ref] : refs[ref] : ref.value;
          if (isUnmount) {
  ...
  var patchProps = function patchProps(el, vnode, oldProps, newProps, parentComponent, parentSuspense, isSVG) {
    if (oldProps !== newProps) {
      ...
      for (var _key14 in newProps) {
        if (shared_esm_bundler_isReservedProp(_key14)) continue;
...
var runtime_core_esm_bundler_Fragment = Symbol["for"]("v-fgt");
var Text = Symbol["for"]("v-txt");
var Comment = Symbol["for"]("v-cmt");
var runtime_core_esm_bundler_Static = Symbol["for"]("v-stc");
var blockStack = [];
...
function _createVNode(type) {
  ...
  var shapeFlag = shared_esm_bundler_isString(type) ? 1 : isSuspense(type) ? 128 : isTeleport(type) ? 64 : shared_esm_bundler_isObject(type) ? 4 : shared_esm_bundler_isFunction(type) ? 2 : 0;
  if (false) {}
...
function patchStyle(el, prev, next) {
  var style = el.style;
  var isCssString = shared_esm_bundler_isString(next);
  if (next && !isCssString) {
...
function autoPrefix(style, rawName) {
  ...
  var name = shared_esm_bundler_camelize(rawName);
...
function parseName(name) {
  ...
  var event = name[2] === ":" ? name.slice(3) : shared_esm_bundler_hyphenate(name.slice(2));
...
var TransitionPropsValidators = Transition.props = /* @__PURE__ */shared_esm_bundler_extend({}, BaseTransitionPropsValidators, DOMTransitionPropsValidators);
var runtime_dom_esm_bundler_callHook = function callHook(hook) {
  var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  if (shared_esm_bundler_isArray(hook)) {
    hook.forEach(function (h2) {
      return h2.apply(void 0, toConsumableArray_toConsumableArray(args));
    });
  } else if (hook) {
...
var hasExplicitCallback = function hasExplicitCallback(hook) {
  return hook ? shared_esm_bundler_isArray(hook) ? hook.some(function (h2) {
    return h2.length > 1;
  }) : hook.length > 1 : false;
};
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/vue/gift-with-purchase/GiftWithPurchase.vue?vue&type=template&id=1f5d5260
...
var _hoisted_11 = ["data-variant-id"];
var _hoisted_12 = {
  key: 1,
  "class": "hr--medium"
};
var _hoisted_13 = ["innerHTML"];
function GiftWithPurchasevue_type_template_id_1f5d5260_render(_ctx, _cache, $props, $setup, $data, $options) {
  var _this = this;
  ...
  }, null, 8, _hoisted_3)], 512), [[vShow, $options.overMessage !== '']]), this.currentTierIndex > -1 ? (openBlock(), createElementBlock("div", _hoisted_4, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList(this.availableTiers[this.currentTierIndex].productData, function (productData) {
...
;// CONCATENATED MODULE: ./src/vue/gift-with-purchase/GiftWithPurchase.vue?vue&type=template&id=1f5d5260
...
/* harmony default export */ const GiftWithPurchasevue_type_script_lang_js = ({
  props: ["tierData"],
  data: function data() {
    return {
      availableTiers: [],
  ...
  methods: {
    updateCartSubtotalCents: function updateCartSubtotalCents(subtotal) {
      this.cartSubtotalCents = subtotal;
    },
    updateGwpInCart: function updateGwpInCart(cart) {
    ...
    getProducts: function getProducts(productIdsArray) {
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var idString, i, mutation;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              idString = "";
              for (i = 0; i < productIdsArray.length; i++) {
                idString += "\"gid://shopify/Product/".concat(productIdsArray[i], "\"");
                if (i + 1 != productIdsArray.length) {
                  idString += ",";
                }
              }
              mutation = "\n        query {\n          nodes(ids: [".concat(idString, "]) {\n            ... on Product {\n              id\n              variants(first: 1) {\n                edges {\n                  node {\n                    id\n                    availableForSale\n                    quantityAvailable\n                  }\n                }\n              }\n              title\n              images (first: 1) {\n                edges {\n                  node {\n                    id\n                    url\n                  }\n                }\n              }\n            }\n          }\n        }\n        ");
              return _context.abrupt("return", fetch("/api/2022-10/graphql.json", {
                headers: {
    ...
    addGwpItem: function addGwpItem(e) {
      e.preventDefault();
      if (this.loading) {
        return;
      }
      this.loading = true;
      var variantId = e.target.dataset.variantId.replace("gid://shopify/ProductVariant/", "");
      var variantData = {
        items: [{
          quantity: 1,
          id: variantId,
  ...
  created: function created() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var tierDataDeepCopy, requests;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            // make a deep copy, as we can't affect the original tier data
            tierDataDeepCopy = JSON.parse(JSON.stringify(_this.tierData)); // populate product data for each of the tiers
            requests = tierDataDeepCopy.map(function (tier) {
              if (tier.productIdsArray.length) {
                return _this.getProducts(tier.productIdsArray);
              }
              return null;
            });
            _context2.next = 4;
          ...
          case 4:
            ...
            tierDataDeepCopy.forEach(function (tier) {
              if (tier.productData.length) {
                tier.productData = tier.productData.filter(function (data) {
            ...
            tierDataDeepCopy = tierDataDeepCopy.filter(function (tier) {
              return tier.productData.length;
            });

            // assign tierDataDeepCopy to the component's data
            _this.availableTiers = tierDataDeepCopy;
          case 7:
          case "end":
  ...
  updated: function updated() {
    ...
    var slider = document.querySelector(".gwp-slider-wrapper");
  ...
  computed: {
    currentTierIndex: function currentTierIndex() {
      var _this2 = this;
      // using -1 just to show that we are not yet in a tier. this will help with other logic
      var currentTierIndex = -1;
      this.availableTiers.forEach(function (tier, i) {
        if (_this2.cartSubtotalCents > tier.threshold) {
    ...
    underMessage: function underMessage() {
      var nextTierIndex = this.currentTierIndex + 1;
      var message = "";
      if (nextTierIndex < this.availableTiers.length) {
        // an underMessage is irrelevant once we are already in the last tier
        var template = this.availableTiers[nextTierIndex].underMessageTemplate;
        var money = this.availableTiers[nextTierIndex].threshold - this.cartSubtotalCents;
        var formattedMoney = theme.Currency.formatMoney(money, theme.settings.moneyFormat);
        message = template.replace("[money]", formattedMoney);
      }
      return message;
    },
    overMessage: function overMessage() {
      var message = "";
...
;
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(GiftWithPurchasevue_type_script_lang_js, [['render',GiftWithPurchasevue_type_template_id_1f5d5260_render]])

/* harmony default export */ const GiftWithPurchase = (__exports__);
