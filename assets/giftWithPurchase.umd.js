(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["giftWithPurchase"] = factory();
	else
		root["giftWithPurchase"] = factory();
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/vue/gift-with-purchase/GiftWithPurchase.vue?vue&type=template&id=372b735c

const _hoisted_1 = {
  key: 0,
  class: "gwp-content-wrapper"
};
const _hoisted_2 = {
...
function GiftWithPurchasevue_type_template_id_372b735c_render(_ctx, _cache, $props, $setup, $data, $options) {
...
;// CONCATENATED MODULE: ./src/vue/gift-with-purchase/GiftWithPurchase.vue?vue&type=template&id=372b735c
...
/* harmony default export */ var GiftWithPurchasevue_type_script_lang_js = ({
  props: ["tierData"],
  data() {
    return {
      availableTiers: [],
  ...
  methods: {
    ...
    async getProducts(productIdsArray) {
      ...
      return fetch("/api/2022-10/graphql.json", {
        headers: {
          ...
          "X-Shopify-Storefront-Access-Token": "2a1c6731e91ea55d317dbefc6ac50463"
        },
        method: "POST",
        body: mutation
    ...
    addGwpItem(e) {
      ...
      this.loading = true;
      const variantId = e.target.dataset.variantId.replace("gid://shopify/ProductVariant/", "");
      var variantData = {
        items: [{
          quantity: 1,
          id: variantId,
  ...
  mounted() {
    ...
    document.addEventListener("ajaxProduct:added", function () {
      ...
      if (typeof theme !== "undefined") {
        theme.cart.getCart().then(function (evt) {
  ...
  updated() {
    ...
    if (slider && this.currentTierIndex > -1 && this.availableTiers[this.currentTierIndex].productData.length > 1) {
      const sliderArgs = {
  ...
  computed: {
    ...
    underMessage() {
      ...
      if (nextTierIndex < this.availableTiers.length) {
        ...
        const template = this.availableTiers[nextTierIndex].underMessageTemplate;
        const money = this.availableTiers[nextTierIndex].threshold - this.cartSubtotalCents;
        const formattedMoney = theme.Currency.formatMoney(money, theme.settings.moneyFormat);
    ...
    overMessage() {
      ...
      if (this.currentTierIndex >= 0) {
        ...
        message = this.availableTiers[this.currentTierIndex].overMessageTemplate;
      }
      return message;
    }
  }
});
;// CONCATENATED MODULE: ./src/vue/gift-with-purchase/GiftWithPurchase.vue?vue&type=script&lang=js
 
// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(89);
;// CONCATENATED MODULE: ./src/vue/gift-with-purchase/GiftWithPurchase.vue




;
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(GiftWithPurchasevue_type_script_lang_js, [['render',GiftWithPurchasevue_type_template_id_372b735c_render]])
